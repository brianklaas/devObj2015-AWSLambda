...
exports.handler = function(event, context) {
	...
	async.waterfall([
		...
		// Send a notification to SQS that this job is complete
		function notifySQS(next) {
			console.log("Notifying SQS that we are done.");
			var messageBody = {
				imageName: srcKey,
			...
			sqs.sendMessage(params, function(err, data) {
			  if (err) {
				...
				console.log('Successfully sent a message to SQS. Result:');
				console.log(data);
				next();
			  }
			});
